## Перестановки
**Перестановками** (*permutations*) называются последовательности длины $n$, состоящие из $n$ различных элементов, и отличающиеся только порядком их расположения [Cочетания](#Коллекции). Число таких комбинаций
